...
#' HPT
#'
#' This function defines a HPT  module for incorporation into a
#' psychTestR timeline.
#' Use this function if you want to include the HPT in a
#' battery of other tests, or if you want to add custom psychTestR
#' pages to your test timeline.
#' For demoing the HPT, consider using \code{\link{HPT_demo}()}.
#' For a standalone implementation of the HPT,
